...
const YesNo = ({
  ...
  <div
    ...
    style={{ border: `1px solid ${BDR}`, background: "rgba(255,255,255,0.02)" }}
  >
    ...
    <div className="flex gap-2">
      {[true, false].map((v) => (
        <button
          ...
          style={{
            borderColor: value === v ? TEAL : "rgba(255,255,255,0.12)",
            background: value === v ? "rgba(61,190,181,0.15)" : "transparent",
            color: value === v ? TEAL : "rgba(255,255,255,0.45)",
          }}
        >
          {v ? "Yes" : "No"}
        </button>
...
const ParentOnboarding = () => {
  ...
  const addChild = () =>
    setChildren((prev) => [...prev, { name: "", age: "", special_needs: "" }]);
  ...
  const saveAll = async () => {
    ...
    const preferences = {
      ...
      sitter_with_pets: sitterWithPets,
    };
    const base: any = {
      user_id: user.id,
    ...
    Promise.resolve(
      supabase.rpc("ensure_user_record", { p_role: "parent" }),
    ).catch(() => {});
    await supabase
      .from("user_roles")
      .upsert({ user_id: user.id, role: "parent" }, { onConflict: "user_id" });
          ...
          >
            ...
            {step === 0 && (
              <div className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    placeholder="Tell babysitters a little about your family..."
                    rows={3}
                    value={about}
            ...
            {step === 1 && (
              <div className="space-y-5">
                ...
                <p className="text-sm text-white/40">
                  Help babysitters understand who they'll be caring for.
                </p>
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateChild(i, "special_needs", e.target.value)
                        }
                      />
                    </div>
                  </div>
            ...
            {step === 2 && (
              <div className="space-y-5">
                ...
                <p className="text-sm text-white/40">
                  This helps match you with babysitters nearby.
                </p>
                <div className="space-y-1.5">
                  <Label>City / Area *</Label>
                  <Input
                    placeholder="e.g. Kuala Lumpur, Bangkok"
                    value={city}
            ...
            {step === 3 && (
              <div className="space-y-5">
                ...
                <p className="text-sm text-white/40">
                  Help us find the right babysitter for your family.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <YesNo
                    value={petsAtHome}
                    onChange={setPetsAtHome}
                    label="Do you have pets at home?"
                  />
                  <YesNo
                    value={sitterWithPets}
                    onChange={setSitterWithPets}
                    label="Are you OK with a babysitter who has pets?"
                  />
                </div>
              </div>
            )}
            ...
            {step === 4 && (
              <div className="text-center space-y-5 py-6">
                ...
                <p className="text-white/40 max-w-xs mx-auto">
                  Your profile is ready. Start browsing babysitters near you.
                </p>
                <div className="flex items-center justify-center gap-6 text-sm text-white/40 pt-1">
                  {children.filter((c) => c.name.trim()).length > 0 && (
                    <span>
                      <strong className="text-white">
                        {children.filter((c) => c.name.trim()).length}
                      </strong>{" "}
                  ...
                  {careTypes.length > 0 && (
                    <span>
                      <strong className="text-white">{careTypes.length}</strong>{" "}
                      care types
                    </span>
                  )}
                  {city && (
