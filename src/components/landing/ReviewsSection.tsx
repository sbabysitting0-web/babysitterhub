...
const ReviewsSection = () => {
  ...
  useEffect(() => {
    ...
    const cards = Array.from(
      grid.querySelectorAll<HTMLElement>(".review-card"),
    );
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "350px",
          background:
            "radial-gradient(circle, rgba(61,190,181,0.07) 0%, transparent 65%)",
          borderRadius: "50%",
          filter: "blur(45px)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: "100px",
          background:
            "linear-gradient(270deg, rgba(61,190,181,0.08) 0%, transparent 100%)",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={titleRef} className="text-center max-w-xl mx-auto mb-14">
          ...
          <p className="text-white/40">
            Don't just take our word for it — here's what families across Asia
            say.
          </p>
        </div>
        ...
        <div ref={gridRef} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {reviews.map((r, idx) => (
            <div
              key={idx}
              className="review-card bg-[#0E1E1A] border border-white/6 rounded-2xl p-6 hover:border-teal/20 hover:shadow-xl hover:shadow-teal/5 transition-all duration-300 flex flex-col"
            >
              <StarRow rating={r.rating} />
              <p className="text-white/60 text-sm leading-relaxed mt-4 mb-5 flex-1">
                "{r.text}"
              </p>
