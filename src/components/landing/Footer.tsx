  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 0%, rgba(61,190,181,0.3) 50%, transparent 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: "300px",
          background:
            "radial-gradient(circle, rgba(61,190,181,0.06) 0%, transparent 65%)",
          borderRadius: "50%",
          filter: "blur(40px)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: "110px",
          background:
            "linear-gradient(90deg, rgba(61,190,181,0.09) 0%, transparent 100%)",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-white/40 leading-relaxed mb-6 max-w-xs">
              Connecting trusted babysitters with loving families across Asia.
          ...
          {/* Platform */}
          <div>
            <h4 className="font-heading font-bold text-sm text-white mb-5">
              Platform
            </h4>
              ...
              {platformLinks.map((l) => (
                <li key={l.label}>
                  {l.anchor ? (
                    <a
                      href={l.href}
                      className="text-sm text-white/40 hover:text-teal transition-colors"
                    >
                      {l.label}
                    </a>
                  ) : (
