...
const features = [
  {
    ...
    description:
      "Every sitter goes through a rigorous ID and background verification before joining.",
  },
  {
    icon: Star,
    title: "Reviewed & rated",
    description:
      "Real ratings from real families. Browse reviews to find the best match.",
  },
  {
    icon: Clock,
    title: "Available 24/7",
    description:
      "Last-minute care? No problem. Find sitters available on short notice.",
  },
  {
    icon: Users,
    title: "12k+ sitters",
    description: "A growing network of trusted babysitters across Asia.",
  },
  {
    icon: Award,
    title: "CPR certified",
    description:
      "Many sitters hold first aid and CPR certifications for your peace of mind.",
  },
  {
    icon: CheckCircle,
    title: "Free to browse",
    description:
      "No hidden fees. Browse, contact, and shortlist sitters for free.",
  },
];
...
const FeaturesSection = () => {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg, #080F0D 0%, #0A1812 100%)",
      }}
    >
      {/* Blobs */}
      <div
        ...
        style={{
          ...
          height: "500px",
          background:
            "radial-gradient(circle, rgba(61,190,181,0.09) 0%, transparent 65%)",
          borderRadius: "50%",
          filter: "blur(60px)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: "200px",
          background:
            "radial-gradient(circle, rgba(61,190,181,0.05) 0%, transparent 70%)",
          borderRadius: "50%",
          filter: "blur(40px)",
        }}
      />
      ...
      />
      <div
        className="absolute right-0 bottom-1/4 pointer-events-none"
        style={{
          width: "55px",
          height: "110px",
          background:
            "linear-gradient(270deg, rgba(61,190,181,0.09) 0%, transparent 100%)",
          borderRadius: "110px 0 0 110px",
          border: "1px solid rgba(61,190,181,0.10)",
          borderRight: "none",
        }}
      />
        ...
        <div ref={gridRef} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feat, idx) => {
            ...
            return (
              <div
                key={idx}
                className="feat-card bg-[#0E1E1A] border border-white/6 rounded-2xl p-7 hover:border-teal/30 hover:shadow-xl hover:shadow-teal/5 transition-all duration-300 group"
              >
